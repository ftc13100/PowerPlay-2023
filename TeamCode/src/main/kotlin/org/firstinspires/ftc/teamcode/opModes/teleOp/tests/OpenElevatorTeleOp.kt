...
import org.firstinspires.ftc.teamcode.constants.DeviceConfig.SLIDES_MOTOR_LEFT
import org.firstinspires.ftc.teamcode.constants.DeviceConfig.SLIDES_MOTOR_RIGHT
...
class OpenElevatorTeleOp(): CommandOpMode() {
    override fun initialize() {
        val leftMotor = Motor(hardwareMap, SLIDES_MOTOR_LEFT.deviceName)
        val rightMotor = Motor(hardwareMap, SLIDES_MOTOR_RIGHT.deviceName)
        leftMotor.inverted = true

        val subsystem = OpenElevatorSubsystem(leftMotor, rightMotor)
